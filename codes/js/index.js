		...
		success: function(data) {
			...
			for(var i = 0; i < data.length; i++) {
				...
				html += "<li><div class = 'time'>剩余<span></span>天<span></span>时<span></span>分<span></span>秒</div><div class = 'sub1'><a href='http://10.9.160.130/codes/html/detail.html'><img src='" +
					...
					data[i].old + "Q币</p><a class = 'btn_buy addcarbtn' id = '" + data[i].id + "'></a></div></li>"
...
$(function() {
	...
	aBtn.mouseleave(function(event) {
		/* Act on the event */
		timerrr = setInterval(timerInner, 2000);
	});
	...
	$(".top").find(".top_login").find(".top_link").find(".c").find(".lost").hover(function() {
		...
		function() {
			$(".top").find(".top_login").find(".top_link").find("#code").css("display", "none")
		});
	...
	//腾讯游戏菜单隐藏与显示
	$(".top .top_game .tx_game").hover(function() {
		$(".top .top_game .box").css("display", "block")
	}, function() {
		$(".top .top_game .box").css("display", "none")
	});
	$(".top .top_game .box").hover(function() {
